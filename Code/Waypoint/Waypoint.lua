...
function WaypointMixin:OnLoad()
    ...
    SavedVariables.OnChange("WaypointDB_Global", "WaypointDistanceText", function() self:UpdateFooterAppearance() end)
    SavedVariables.OnChange("WaypointDB_Global", "WaypointDistanceTextType", function() self:UpdateFooterAppearance() end)
    SavedVariables.OnChange("WaypointDB_Global", "WaypointDistanceTextAlpha", function() self:UpdateFooterAppearance() end)
    SavedVariables.OnChange("WaypointDB_Global", "WaypointDistanceTextScale", function() self:UpdateFooterAppearance() end)
