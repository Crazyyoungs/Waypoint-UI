...
L["Config - ExtraFeature - DugisSupport"] = "Поддержка Dugi Questing Essential"
L["Config - ExtraFeature - DugisSupport - Enable"] = "Отслеживать метки Dugi"
L["Config - ExtraFeature - DugisSupport - Enable - Description"] = "Включает поддержку отслеживания путевых точек аддона Dugi Questing Essential через Waypoint UI."
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint"] = "Автозамена путевой точки"
L["Config - ExtraFeature - DugisSupport - AutoReplaceWaypoint - Description"] = "Автоматически отслеживать текущую путевую точку Dugi."
L["Config - ExtraFeature - RareScannerSupport"] = "Поддержка RareScanner"
L["Config - ExtraFeature - RareScannerSupport - Enable"] = "Отслеживать найденную цель RareScanner"
L["Config - ExtraFeature - RareScannerSupport - Enable - Description"] = "Отслеживать оповещения о найденных целях RareScanner через Waypoint UI. Если включено, собственная опция путевых точек RareScanner будет временно отключена."
L["Config - ExtraFeature - RareScannerSupport - AutoReplaceWaypoint"] = "Автозамена путевой точки"
L["Config - ExtraFeature - RareScannerSupport - AutoReplaceWaypoint - Description"] = "Автоматически отслеживать последнее оповещение о найденной цели."
L["Config - ExtraFeature - SilverDragonSupport"] = "SilverDragon"
L["Config - ExtraFeature - SilverDragonSupport - Enable"] = "Enhance Silver Dragon Waypoints"
...
L["DugisGuideViewerZ - ReplacePrompt"] = "Do you want to replace your current waypoint with the Dugi waypoint \"%s\"?"
L["DugisGuideViewerZ - ReplacePrompt - Yes"] = "Replace"
L["DugisGuideViewerZ - ReplacePrompt - No"] = "Cancel"
L["RareScanner - ReplacePrompt"] = "Do you want to replace your current waypoint with the RareScanner waypoint \"%s\"?"
L["RareScanner - ReplacePrompt - Yes"] = "Replace"
L["RareScanner - ReplacePrompt - No"] = "Cancel"
